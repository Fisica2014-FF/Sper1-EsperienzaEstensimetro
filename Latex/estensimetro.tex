...
\section{Presentazione dati sperimentali}			
	...
	\begin{grafico}
    \centering
		\input{../GnuPlot/immagini/E3_grafico.tex}
	...
	\begin{figure}[H]
    \centering
		\input{../GnuPlot/immagini/E5_grafico.tex}
		\caption{Spazio!}
		\label{fig:spazio1}
	\end{figure}
	...
	\begin{figure}[H]
    \centering
		\input{../GnuPlot/immagini/E8_grafico.tex}
		\caption{Spazio!}
		\label{fig:spazio1}
	\end{figure}
	...
	\begin{figure}[H]
    \centering
		\input{../GnuPlot/immagini/E13_grafico.tex}
		\caption{Spazio!}
		\label{fig:spazio1}
	\end{figure}
	...
	\begin{figure}[H]
    \centering
		\input{../GnuPlot/immagini/E16_grafico.tex}
		\caption{Spazio!}
		\label{fig:spazio1}
	\end{figure}
	...
	\begin{figure}[H]
    \centering
		\input{../GnuPlot/immagini/E17_grafico.tex}
		\caption{Spazio!}
		\label{fig:spazio1}
	\end{figure}
